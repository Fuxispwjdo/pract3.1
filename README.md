...
Требования: 
  1. Интерпретатор должен принимать на вход аргументы командной строки: – Путь к бинарному файлу с ассемблированной программой. – Путь к файлу, куда будет сохранен дамп памяти после выполнения 
  программы. – Диапазон адресов памяти для вывода дампа. 
...
Требования: 
  ...
  выполнить поэлементно команду abs() над вектором длины 5. Результат 
